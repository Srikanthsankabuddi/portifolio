    ...
    if request.method == "POST":
        ...
        try:
            ...
            send_mail(
                ...
                f"Name: {name}\nEmail: {email}\nMessage:\n{message}",
                "sankabuddisrikanth05@gmail.com",
                ["sankabuddisrikanth05@gmail.com"],  # admin email
            )
    ...
    if request.method == 'POST':
        try:
            ...
            send_mail(
                ...
                from_email='sankabuddisrikanth05@gmail.com',
                recipient_list=['sankabuddisrikanth05@gmail.com'],
                fail_silently=False,
            )
